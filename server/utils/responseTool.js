...
class ResponseTool{
   ...
   * @param {Array} responseResult 数组，格式为 [ code, message, data = null ]，数组中的参数分别为 返回码、返回提示信息、用户请求的数据
   */
   ...
   * 成功响应
   * @param {*} res Express 框架的 response 对象
   * @param {Array} responseResult 待返回的数据，格式为 [ code, message, data = null ]，数组中的参数分别为 返回码、返回提示信息、用户请求的数据
   */
